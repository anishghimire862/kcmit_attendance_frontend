...
export default {
  ...
  methods: {
    ...
    subjectFilter() {
      ...
      let filteredSubjects = this.subjects.filter(subject => subject.semester == selectedSemester && subject.faculty == selectedFaculty).push({ id: subject.subjectId, subject_name: subject.subject_name })
